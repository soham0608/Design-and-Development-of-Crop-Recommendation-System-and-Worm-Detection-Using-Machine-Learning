...
root.title("Worm Detection")


#430
#++++++++++++++++++++++++++++++++++++++++++++
#####For background Image
image2 = Image.open('h8.jpg')
...
#
lbl = tk.Label(root, text="Worm Detection Using Image Processing", font=('times', 24,' bold '), height=1, width=75,bg="green",fg="white")
lbl.place(x=0, y=0)



frame_alpr = tk.LabelFrame(root, text=" --Process-- ", width=220, height=400, bd=5, font=('times', 14, ' bold '),bg="black",fg='white')
...
#    global fn
    ...
    if fn!="":
        ...
        model = load_model('warm_model.h5')
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='C:/Users/rohit/Desktop/23CP143/23CP143-Worm+Crop classification (1)/main dataset', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
...
button4 = tk.Button(frame_alpr, text="CNN Classification", command=test_model,width=15, height=1,bg="white",fg="black", font=('times', 15, ' bold '))
