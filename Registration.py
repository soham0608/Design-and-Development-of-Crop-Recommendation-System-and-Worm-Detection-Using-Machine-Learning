...
window.configure(background="#ACE1AF")
...
def insert():
    ...
    if (fname.isdigit() or (fname == "")):
        ...
        with conn:
            ...
            conn.commit()
            db.close()
            ms.showinfo('Success!', 'User Account Created Successfully !')
...
l1 = tk.Label(window, text="User Information", font=("Times new roman", 30, "bold"),  fg="Black",bg='#ACE1AF')
l1.place(x=190, y=20)

# that is for label1 registration

l2 = tk.Label(window, text="Full Name :", width=12, font=("Times new roman", 15, "bold"), bg="#ACE1AF")
...
l3 = tk.Label(window, text="Address :", width=12, font=("Times new roman", 15, "bold"), bg="#ACE1AF")
...
l5 = tk.Label(window, text="E-mail :", width=12, font=("Times new roman", 15, "bold"), bg="#ACE1AF")
l5.place(x=130, y=200)
t4 = tk.Entry(window, textvar=Email, width=20, font=('', 15))
t4.place(x=330, y=200)
# that is for email address

l6 = tk.Label(window, text="Phone number :", width=12, font=("Times new roman", 15, "bold"), bg="#ACE1AF")
l6.place(x=130, y=250)
t5 = tk.Entry(window, textvar=Phoneno, width=20, font=('', 15))
t5.place(x=330, y=250)
# phone number
l7 = tk.Label(window, text="Gender :", width=12, font=("Times new roman", 15, "bold"), bg="#ACE1AF")
l7.place(x=130, y=300)
# gender
tk.Radiobutton(window, text="Male", padx=5, width=5, bg="#ACE1AF", font=("bold", 15), variable=var, value=1).place(x=330,
                                                                                                                y=300)
tk.Radiobutton(window, text="Female", padx=20, width=4, bg="#ACE1AF", font=("bold", 15), variable=var, value=2).place(
    x=440, y=300)

l8 = tk.Label(window, text="Age :", width=12, font=("Times new roman", 15, "bold"), bg="#ACE1AF")
l8.place(x=130, y=350)
t6 = tk.Entry(window, textvar=age, width=20, font=('', 15))
t6.place(x=330, y=350)

l4 = tk.Label(window, text="User Name :", width=12, font=("Times new roman", 15, "bold"), bg="#ACE1AF")
l4.place(x=130, y=400)
t3 = tk.Entry(window, textvar=username, width=20, font=('', 15))
t3.place(x=330, y=400)

l9 = tk.Label(window, text="Password :", width=12, font=("Times new roman", 15, "bold"), bg="#ACE1AF")
l9.place(x=130, y=450)
t9 = tk.Entry(window, textvar=password, width=20, font=('', 15), show="*")
t9.place(x=330, y=450)

l10 = tk.Label(window, text="Confirm Password:", width=13, font=("Times new roman", 15, "bold"), bg="#ACE1AF")
l10.place(x=130, y=500)

t10 = tk.Entry(window, textvar=password1, width=20, font=('', 15), show="*")
t10.place(x=330, y=500)

btn = tk.Button(window, text="Submit", bg="green",font=("",20),fg="white", width=9, height=1, command=insert)
