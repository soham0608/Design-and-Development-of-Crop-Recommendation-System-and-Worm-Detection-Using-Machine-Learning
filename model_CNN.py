...
path1 = 'D:/Final code/warm Detection/warm Detection/testing/1'    #path of folder of images    
path2 = 'D:/Final code/warm Detection/warm Detection/testing_set/1'  #path of folder to save images    
